...
export const metadata: Metadata = {
  title: "Sign up — Athlo Club",
  description: "Create your free Athlo Club athlete profile, or start your first event as an organiser.",
};
...
export default function SignupPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-6 py-20">
      <p className="text-sm font-semibold uppercase tracking-widest text-lime">Sign up</p>
      <h1 className="mt-4 text-3xl font-extrabold tracking-tight">Create your account.</h1>
      <p className="mt-3 text-grey-400">
        Free for athletes, forever. Organisers can start their first event
        free too — you only pay when you get paid.
      </p>
